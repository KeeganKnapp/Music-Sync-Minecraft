...
execute if score #song music_random matches 1 as @a[tag=underwater_music_sync] at @s run playsound globalmusic:c418_axolotl music @a[tag=underwater_music_sync]
...
execute if score #song music_random matches 2 as @a[tag=underwater_music_sync] at @s run playsound globalmusic:c418_dragon_fish music @a[tag=underwater_music_sync]
...
execute if score #song music_random matches 3 as @a[tag=underwater_music_sync] at @s run playsound globalmusic:c418_shuniji music @a[tag=underwater_music_sync]
