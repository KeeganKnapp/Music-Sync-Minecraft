...
execute if score #song music_random matches 1 as @a[tag=end_music_sync] at @s run playsound globalmusic:boss music @a[tag=end_music_sync]
...
execute if score #song music_random matches 2 as @a[tag=end_music_sync] at @s run playsound globalmusic:the_end music @a[tag=end_music_sync]
